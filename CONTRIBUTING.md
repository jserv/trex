...
The following is a set of guidelines for contributing to [trex](https://github.com/jserv/trex)
...
Visit our [Issues page on GitHub](https://github.com/jserv/trex/issues) to search and submit.
